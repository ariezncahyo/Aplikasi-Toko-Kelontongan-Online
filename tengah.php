  ...
  echo "<div class='center_title_bar'>Hubungi Kami</div>
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Terimakasih</div>
              <div>
              <br />Terimakasih telah menghubungi kami.<br /><br /> 
              </div>
...
$pesan="Terimakasih telah melakukan pemesanan online di PD. Maju Jaya Sentosa <br /><br />  
        Nama: $nama <br />
        Alamat: $alamat <br/>
        Telpon: $telpon <br /><hr />
...
mysql_query("update orders set total=$total WHERE id_orders='$id_orders'");
...
$pesan.="<br /><br />Total : Rp. $total_rp 
         ...
         <br /><br />Silahkan lakukan pembayaran ke Rekening PD. Maju Jaya Sentosa";

$subjek="Pemesanan Online PD. Maju Jaya Sentosa";

// Kirim email dalam format HTML
$dari = "From: admin@majujayasentosa.com\r\n";
...
mail("admin@majujayasentosa.com",$subjek,$pesan,$dari);
