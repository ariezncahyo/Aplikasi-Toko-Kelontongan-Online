...
$r=mysql_fetch_array(mysql_query("SELECT * FROM admins where username='".$_SESSION[username]."'"));
...
if ($pass_lama==$r[password]){
  ...
  if ($_POST[pass_baru]==$_POST[pass_ulangi]){
    mysql_query("UPDATE admins SET password = '$pass_baru' where username='".$_SESSION[username]."'");
